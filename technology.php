<?php
$GLOBALS['title'] = "Technology - Digital Locations";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>

<section class="mbanner" style="background-image: url(./assets/img/market-bg.png);">
    <div class="container">
        <h1>Technology</h1>
    </div>
</section>

<section class="technologyA">
    <div class="container">
        <div class="technologyA__title">
    ...
    <div class="technologyA__graphic">
        <img src="./assets/img/technology-about.jpg" alt="technology">
    </div>
</section>

<section class="isPossible">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 order-lg-0 order-1">
                <div class="isPossible__mobile">
                    <img src="./assets/img/phone.png" alt="phone">
                </div>
            </div>
            <div class="col-lg-7 order-lg-1 order-0">
                <div class="isPossible__content">
...
<section class="novalaPP">
    ...
    <div class="novalaPP__graphic">
        <img src="./assets/img/noval.jpg" alt="noval">
    </div>
    <div class="container">
...
<section class="frontier techfrontier">
    <div class="container">
        <h3>Space... <br>
            the new frontier</h3>
    ...
    <div class="container">
        <div class="frontier__text">
            <p>Thanks to a new generation of visionary space companies such as SpaceX (Elon Musk) and Blue Origin (Jeff Bezos), the cost of launching satellites into space has come down dramatically through reusable rocket technology and more frequent space missions. As a result, it is now possible to deploy small, low-cost satellites that are in low Earth orbit (“LEO”). Closer to Earth means faster data transmission. However, it’s still very expensive and still needs special large receiver dishes mounted on fixed locations.</p>
        </div>
        <div class="frontier__spacex">
            <img src="./assets/img/spacex.png" alt="spacex">
        </div>
    </div>
</section>

<section class="broadband techbroadband">
