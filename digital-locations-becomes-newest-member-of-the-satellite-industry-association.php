<?php
$GLOBALS['title'] = "Digital Locations Becomes Newest Member of the Satellite Industry Association - Digital Locations";
$GLOBALS['desc'] = "";
$GLOBALS['keywords'] = "";
include('header.php'); ?>
...
<div class="cde__content">
    <div class="container">
        <h3>Digital Locations Becomes Newest Member of the Satellite Industry Association</h3>
        <span>June 27, 2023</span>
        <h2>The Company joins a leading group of participants in the U.S. satellite industry </h2>

        <p>SANTA BARBARA, CA, June 27, 2023 (GLOBE NEWSWIRE) -- Digital Locations, Inc. (DLOC), the developer of a disruptive technology that will deliver high-speed Internet from satellites directly to smartphones all over the world, today announced that it has been accepted as member of the Satellite Industry Association (SIA) which represents a leading group of participants in the U.S. satellite industry. </p>

        <p>The Satellite Industry Association (SIA) is a United States-based trade association providing representation of the leading domestic satellite operators, service providers, manufacturers, launch services providers, and ground equipment suppliers. Since 1995, SIA has advocated on behalf of the commercial U.S. satellite industry on policy, regulatory, and legislative issues affecting the satellite business. SIA is a recognized focal point for the U.S. satellite industry in Washington, DC, representing and advocating industry positions with key policy makers on Capitol Hill and with the White House, Federal Communications Commission and key Executive Branch departments and agencies. </p>

        <p>“We are grateful to be accepted as a member of the Satellite Industry Association,” said Rich Berliner, CEO of Digital Locations. “We look forward to working with the SIA and other members to help build and strengthen the satellite industry.” </p>
